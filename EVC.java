        ...
        if (dial.equals(dial2)) {
            ...
            if (pin == pin2) {
                ...
                switch (num) {
                    ...
                    case 6:
                        double bankBalance = 700;
                        String bankPassword = "374790";
                        input.nextLine();
                        ...
                        switch (bankOption) {
                            ...
                            case 3:
                                ...
                                if (pass.equals(bankPassword)) {
                                    System.out.print("Geli lacagta aad rabto in aad LA BAXDO: ");
                                    double withdraw = input.nextDouble();
                                    if (withdraw > bankBalance) {
                                        System.out.println(" Haraaga bank-ga kuma filna!");
                                    } else {
                                        bankBalance -= withdraw;
                                        System.out.println(" WAXAD LA BAXDAY $" + withdraw);
                                        System.out.println("Haraagaaga hadda waa: $" + bankBalance);
                                    }
                                } else {
                                    System.out.println(" Password-ka waa khalad! Lacag lama BIXIN.");
                                }
                                break;

                            case 4:
                                System.out.print("Geli lacagta aad rabto INAAD LA BAXDO EVC: ");
                                double evcToBank = input.nextDouble();
                                if (evcToBank > haraa) {
                                    System.out.println(" Haraaga EVC kuguma filna!");
                                } else {
                                    haraa -= evcToBank;
                                    bankBalance += evcToBank;
                                    System.out.println(" Waxaad LA BAXDAY EVC $" + evcToBank + " una wareejisay Salaam Bank.");
                    ...
                    case 7:
                        ...
                        break;
                    case 8:
                        System.out.println(" IGA RAALI NOQO MA GARANAYO SIDUU SYSTEM_KA TAAJ U SHAQEEYO!.");
                        break;
